...
export declare const conversationInsertSchema: import("drizzle-zod").BuildSchema<"insert", {
    id: import("drizzle-orm/mysql-core").MySqlColumn<{
        name: "id";
        tableName: "conversations";
        dataType: "number";
...
export declare const conversationUpdateSchema: import("drizzle-zod").BuildSchema<"update", {
    id: import("drizzle-orm/mysql-core").MySqlColumn<{
        name: "id";
        tableName: "conversations";
        dataType: "number";
