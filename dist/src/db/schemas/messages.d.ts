...
export declare const messageInsertSchema: import("drizzle-zod").BuildSchema<"insert", {
    id: import("drizzle-orm/mysql-core").MySqlColumn<{
        name: "id";
        tableName: "messages";
        dataType: "number";
...
export declare const messageUpdateSchema: import("drizzle-zod").BuildSchema<"update", {
    id: import("drizzle-orm/mysql-core").MySqlColumn<{
        name: "id";
        tableName: "messages";
        dataType: "number";
