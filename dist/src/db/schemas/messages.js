...
exports.messageSchema = exports.messageUpdateSchema = exports.messageInsertSchema = exports.messagesRelations = exports.messages = void 0;
...
exports.messages = (0, mysql_core_1.mysqlTable)('messages', {
    ...
    role: (0, mysql_core_1.varchar)({ length: 255 }).notNull(),
    conversation_id: (0, mysql_core_1.int)().notNull(),
