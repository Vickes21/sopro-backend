...
let ConversationsService = class ConversationsService {
    ...
    async create(data, relations = []) {
        const validated = conversations_1.conversationInsertSchema.parse(data);
    ...
    async update(id, data) {
        const validated = conversations_1.conversationUpdateSchema.parse(data);
    ...
    async getOrCreate(contactId, relations = []) {
        ...
        const conversationData = conversations_1.conversationInsertSchema.parse({
